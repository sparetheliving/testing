_G.CamlockEnabled = true
_G.CamlockKeybind = "Q"
_G.YPosKeybind = "C"
_G.Mode = "Toggle" -- "Toggle" or "Hold"
_G.DistanceFlag = true
_G.MaxDistance = 500
_G.CrewFlag = true
_G.KOFlag = true
_G.FOV = 150
...
_G.TriggerbotActivationKey = "Q"
_G.TriggerbotDelay = 0
_G.TriggerbotCooldown = 0
_G.TriggerbotHoldTime = 0.02

_G.PanicKeybind = "Home"
_G.Version = "Alpha v2.1.1"

local Version = "Alpha v2.1.1"
...
local function TriggerbotMain()
	...
	if TriggerbotHitboxDetected then return end
	if os.clock() - TriggerbotTime < _G.TriggerbotDelay then return end
